...
<?php $listar="select * from anuncioadoc where ativo=0 and destaque=1 order by cod_anuncio desc;";
...
$insere="INSERT INTO likespetsi (cod_anunciopetsi,like_postpetsi,cod_utilizador) VALUES('".$id."',1,'".$_SESSION["cod_utilizador"]."')";
 ...
 $listar="select * from anunciopetsi where ativo=0 and destaque=1 order by cod_anunciopetsi desc;";
...
$listar="select * from anuncioaband where ativo=0 and destaque=1 order by cod_anuncioaband desc;";
...
<!--<div><i class="heart fa fa-heart-o"></i></div>-->