		...
		?>
			...
			<form method="POST" class="register-form" id="register-form" action="editar_perfil.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" value="<?php echo $_SESSION['email_utilizador'];?>" disabled />
                            </div>
							
							<div class="form-group">
                                <label for="date"><img src="images/calendar.png"/></label>
                                <input type="date" name="datanasc" id="datanasc" value="<?php echo $datanasc;?>" disabled  placeholder="Sem Informações"/>
                            </div>

							<div class="form-group">
                                <label for="text"><img src="images/house.png"/></label>
                                <input type="text" name="morada" id="morada" value="<?php echo $morada;?>" disabled placeholder="Sem Informações"/>
                            </div>
							...
							<div class="form-group form-button" align="center">
								  <input type="submit" name="" id="signup" class="form-submit" value="Editar Perfil"/>
							</div>
